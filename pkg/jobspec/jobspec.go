...
func CreateJobSpecYaml(spec *pb.ResourceSpec, count int32, filename string) error {
...
func createSocketResources(spec *pb.ResourceSpec) []Resource {
...
func createResources(spec *pb.ResourceSpec, socketResources []Resource, count int32) []Resource {
