...
DESCRIPTION = "Python gRPC functions for Fluxion, the Flux Framework flux-sched project"
...
if __name__ == "__main__":
    setup(
        ...
        zip_safe=False,
        url="https://github.com/converged-computing/fluxion/tree/main/python/v1",
        license="MIT",
